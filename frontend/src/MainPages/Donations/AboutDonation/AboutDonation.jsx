...
function AboutDonation() {
  ...
  const submitClick = async () => {
    ...
    const res = await axios
      .post(`http://localhost:3000/api/donation/requestdonation`, {
        data: request,
      })
      .then((res) => {
        console.log(res);
  ...
  return (
    <>
      ...
      <div style={{ padding: "12em" }}>
          ...
          <dl className='divide-y divide-gray-100'>
            <div className='px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0'>
              ...
              <dd className='mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0'>
                {data.donorId && data.donorId.fname}{" "}
                {data.donorId && data.donorId.lname}
              </dd>
            </div>
            <div className='px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0'>
              <dt className='text-sm font-medium leading-6 text-gray-900'>
            ...
            <div className='px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0'>
              ...
              <dd className='mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0'>
                {data.donorId && data.donorId.email}
              </dd>
            </div>
            <div className='px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0'>
              <dt className='text-sm font-medium leading-6 text-gray-900'>
        ...
        <div style={modalIsOpen ? { opacity: 0.3 } : { display: "" }}>
          {data.lat && data.lng && ngoData.lat && (
            <Map
              lat={data.lat.$numberDecimal}
              lng={data.lng.$numberDecimal}
              ngoLat={ngoData.lat.$numberDecimal}
              ngoLng={ngoData.lng.$numberDecimal}
            ></Map>
          )}
        </div>
      ...
      >
        {modalData && (
          <div>
            ...
            >
              <button onClick={handleClick}>Close X</button>
            </div>
